...
describe('HashEngineTest', () => {
  ...
  it('HashEngineTest with 100 test elements hex encoding and sha256 hash algorithm', async () => {
    const expected =
  ...
  it('HashEngineTest with 1_000 test elements hex encoding and sha256 hash algorithm', async () => {
    const expected =
  ...
  it('HashEngineTest with 10_000 test elements hex encoding and sha256 hash algorithm', async () => {
    const expected =
  ...
  it('HashEngineTest with 50_000 test elements hex encoding and sha256 hash algorithm', async () => {
    const expected =
  ...
  it('HashEngineTest with 100_000 test elements hex encoding and sha256 hash algorithm', async () => {
    const expected =
