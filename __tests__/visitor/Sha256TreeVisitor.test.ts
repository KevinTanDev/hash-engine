...
describe('SHA256TreeVisitorTest', () => {
  // Assert if setTimeout was called properly
  it('visitRootTest', async () => {

    const expected =
      'f4bddde4aec456db7a792c755016ac4d5781bdb004b0c515839ce71181441a25';
  ...
  it('visitRoot with 100 test elements', async () => {
    const expected =
  ...
  it('visitRoot with 1_000 test elements', async () => {
    const expected =
  ...
  it('visitRoot with 10_000 test elements', async () => {
    const expected =
  ...
  it('visitRoot with 50_000 test elements', async () => {
    const expected =
  ...
  it('visitRoot with 100_000 test elements', async () => {
    const expected =
